...
date: 'created 4 October 2021, updated `r format(Sys.Date(), "%d. %B %Y")`'
...
#ggplot(data = Western_Europe, x = _______, y = ________) +
...
Western_Europe %>% 
  ...
  geom_line(lwd = 2)+
  theme_classic()+
  labs(title = "Homicide rates in Europe over Time",
       x = "Year",
...
ggsave("homicides3.png", width = 15, height = 10, dpi = 150)
